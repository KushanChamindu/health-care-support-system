...
import 'package:healthcaresupportsystem/Pages/HTD/HTD_Pages/HTD_details.dart';
...
class HTD_More extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new Column(
        children: <Widget>[
          new GradientAppBar("More Info", '/HTD_home'),
          new Body(),
        ],
      ),
    );
...
List<Disease> diseases = [
  const Disease(
    ...
    image: "assets/HTD/images/function.png",
    image1: "assets/HTD/images/heartfunction.gif",
    description:
  ...
  const Disease(
      ...
      image: "assets/HTD/images/diagnosis.png",
      image1: "assets/HTD/images/more1.gif",
      description:
  ...
  const Disease(
      ...
      image: "assets/HTD/images/chest.png",
      image1: "assets/HTD/images/chestxray.gif",
      description:
  ...
  const Disease(
    ...
    image: "assets/HTD/images/stresstest.png",
    image1: "assets/HTD/images/stresstest.gif",
    description:
        "A stress test can determine your risk of having heart disease. A doctor or trained technician performs the test. He’ll learn how much your heart can manage before an abnormal rhythm starts or blood flow to your heart muscle drops./nThere are different types of these. The exercise stress test -- also known as an exercise electrocardiogram, treadmill test, graded exercise test, or stress EKG -- is used most often. It lets your doctor know how your heart responds to being pushed. You’ll walk on a treadmill or pedal a stationary bike. It’ll get more difficult as you go. Your electrocardiogram, heart rate, and blood pressure will be tracked throughout.",
  ),
  const Disease(
    name: "Echocardiogram",
    image: "assets/HTD/images/endo.png",
    image1: "assets/HTD/images/endotest.gif",
    description:
        "An echocardiogram is a test that uses ultrasound to show how your heart muscle and valves are working.The sound waves make moving pictures of your heart so your doctor can get a good look at its size and shape. You might hear them call it “echo” for short.Why Do I Need an Echocardiogram?\nYour doctor may order an echocardiogram to:\nLook for heart disease\nMonitor heart valve disease over time\nSee how well medical or surgical treatments are working",
  ),
];
