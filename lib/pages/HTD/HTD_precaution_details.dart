...
//set the background gif
  Container _getBackground(){
    return new Container(
        child: new Image.asset(precaution.image1,
          fit:BoxFit.cover,
          height:350,
        ),
...
//setting content
  Widget _getContent(){
    ...
    return new ListView(
      ...
      children:<Widget>[
        new ContentHeading(precaution,horizontal: false),
        new Container(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              new Separator(),
              new Text(precaution.description,style:Style.commonTextStyle,textAlign: TextAlign.left,),
            ],
          ),
        ),
      ],
...
class ContentHeading extends StatelessWidget{
  ...
  ContentHeading(this.precaution,{this.horizontal=true});
  ContentHeading.vertical(this.precaution): horizontal=false;
  Widget build(BuildContext context){
    ...
    return new GestureDetector(
        onTap: horizontal? () => Navigator.of(context).push(
          new PageRouteBuilder(
            pageBuilder: (_, __, ___) => new DetailPage(precaution),
